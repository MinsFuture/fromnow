...
public interface SwaggerBoardApi {
    ...
    ResponseEntity<ApiBasicResponse> createBoard(
    ...
    ResponseEntity<ApiDiaryResponse<List<BoardOverViewResponseDto>>> getBoardOverviews(
    ...
    ResponseEntity<ApiBasicResponse> clickLike(
            @Parameter Long id,
            @Parameter PrincipalDetails principalDetails);
    ...
    ResponseEntity<ApiBasicResponse> clickDisLike(
            @Parameter Long id,
            @Parameter PrincipalDetails principalDetails);
